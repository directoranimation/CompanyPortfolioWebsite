...
export default function MilestoneSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full sm:h-[100vh] lg:h-[70vh] relative flex items-center justify-center z-20 py-16 px-6">
      {/* <Image src={EllipseTilt} alt="EllipseTilt" className="absolute w-full h-full -z-10" /> */}
      <div className="flex flex-col lg:flex-row items-center justify-between py-16 w-[90%] md:w-5/6 lg:w-4xl xl:w-5xl 2xl:w-7xl">
        <div className="z-40 bg-white rounded-lg w-full md:w-[90%] sm:h-80 lg:w-[45%] xl:w-2/5">
          <Image src="/image.png" alt="Modern Office" width={600} height={500} className="rounded-lg shadow-lg min-md:h-80" />
        </div>
